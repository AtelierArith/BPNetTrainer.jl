...
# ╔═╡ bd5acb68-548b-11f0-1080-5b66c7cec106
begin
	ENV["DATADEPS_ALWAYS_ACCEPT"] = true
	using MLDatasets: MNIST
	using OneHotArrays: onehotbatch
	using Random
	using Lux, Optimization, MLUtils, ComponentArrays
	using OptimizationOptimJL
	using OptimizationOptimisers
	import Optimisers, Optim
	using IterTools: ncycle
	import Zygote
end

# ╔═╡ 044eb868-7e7a-4602-b8ba-0d3746af7d06
md"""
# Training a simple model using Optimization.jl with MNIST Dataset

## References
 - https://docs.sciml.ai/Optimization/stable/tutorials/minibatch/
"""

# ╔═╡ c689e4dc-e24c-4fd9-8f12-5c899573241c
md"""
## Setup dataset
"""

# ╔═╡ 16cbf6f5-c2ed-4049-91bf-20782ba648ff
function loadmnist(ndata=2048)
    # Load MNIST
    dataset = MNIST(; split = :train)[1:ndata] # Partial load for demonstration
    imgs = dataset.features
    labels_raw = dataset.targets

    # Process images into (H,W,C,BS) batches
    x_data = Float32.(reshape(imgs, 784, size(imgs, 3)))
    y_data = onehotbatch(labels_raw, 0:9)

    return (x_data, y_data)
end

# ╔═╡ 4ce590c8-1637-4bba-8dd3-b4a8ce6c194e
md"""
## Setup model
"""

# ╔═╡ 32d1aa0a-b62e-4874-837f-92153f45c136
begin
	model = Chain(
		Dense(28 * 28, 100, tanh), 
		Dense(100, 100, tanh), 
		Dense(100, 50, tanh), 
		Dense(50, 10)
	) 
...
# ╔═╡ e18cbb75-3258-459b-8633-5f77c827278b
md"""
## Setup loss function
"""

# ╔═╡ ee9df499-2e62-40f2-ac7d-ca8dd638bd76
begin
	...
	function loss_function(p, dataloader::MLUtils.DataLoader)
		...
		for batch in dataloader
			s += loss_function(p, batch)	
		end
		s
	end
end

# ╔═╡ 695b907a-cd1d-4680-bb1a-b7b29ae72d6e
optfun = OptimizationFunction(
    loss_function,
    Optimization.AutoZygote()
)

# ╔═╡ fde6ba59-5142-45e7-ba7d-12fda6dfda14
md"""
## Optimisation.ADAM
"""

# ╔═╡ ee8f7264-8eed-4250-a0d1-f960bd7d7a25
let
	...
	optprob = OptimizationProblem(optfun, ps_ca, train_dataloader)
	
	res_with_adam = Optimization.solve(
	    optprob, Optimisers.ADAM(); 
		callback = callback, 
		epochs = 5,
	)
end

# ╔═╡ 56152fc5-a577-4470-90b9-58ff124a406a
md"""
## Optim.LBFGS
"""

# ╔═╡ f43a2960-8e6c-4d23-adbc-d0469e866fdf
let
	ndata = 2048
	train_dataloader =
	DataLoader(
...
manifest_format = "2.0"
project_hash = "72136ef9717579864927fb166a910987b5c4eda8"
...
git-tree-sha1 = "4a2c2d4bb4eb6bbab8e2871657372cf743ff50d5"
...
git-tree-sha1 = "57db7a10930d4ccc9e4ee3d9122748f845e645cf"
